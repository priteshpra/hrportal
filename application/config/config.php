...
*/
$config['proxy_ips'] = '';
$config['sSecretKey'] = 'cvbuilder123456789'; // Key size should be 16 or 32 for mcrypt_encrypt function


define('FIREBASE_API_KEY',    'AIzaSyAUXy5wjDK42osZUjj2Qx1KdNDdqegE0zk');
