...
class Smstemplate extends Admin_Controller {
    ...
    public function index($per_page_record = 10, $page_number = 1) {
        try {
            ...
            $smstemplate_result = array();
            $smstemplate_result['view_modal_popup'] = $this->load->view('admin/includes/view_modal_popup', NULL, TRUE);
            $this->load->view('admin/masters/smstemplate/list', $smstemplate_result);
            $data = array();
            $data['page_level_js'] = $this->load->view('admin/masters/smstemplate/list_js', NULL, TRUE);
            
            $this->load->view('admin/includes/footer', $data);
            unset($smstemplate_result);
            unset($data);
        } catch (Exception $e) {
            echo $e->getMessage();
