...
class Payments_pro extends Front_Controller 
{
	...
	function index()
	{  
		$this->load->view('front/paypal/samples/payments_pro');
	}
	...
	function Do_direct_payment()
	{
		...
		$CCDetails = array(
							...
							'acct' => '4032035495165508', 								// Required.  Credit card number.  No spaces or punctuation.  
							'expdate' => '112021', 							// Required.  Credit card expiration date.  Format is MMYYYY
		...
		if(!$this->paypal_pro->APICallSuccessful($PayPalResult['ACK']))
		{
			...
			$this->load->view('front/paypal/samples/error',$errors);
		}
		else
		{
			// Successful call.  Load view or whatever you need to do here.
			$data = array('PayPalResult'=>$PayPalResult);
			$this->load->view('front/paypal/samples/do_direct_payment',$data);
		}
	}
	...
	{		
		...
		else
		{
			// Successful call.  Load view or whatever you need to do here.
			$data = array('PayPalResult'=>$PayPalResult);
			$this->load->view('front/paypal/samples/get_balance',$data);
		}
	}
