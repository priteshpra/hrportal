<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "company/employeedetails/employee_listing/" + current_page_size + "/" + total_page,
            data: {
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_employeedetails');?>");
 ...
 //var field_name = ["search_text"]; 
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "company/employeedetails/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_companyuser";
        var field_name = "UserID";
        $.ajax({
            type: "post",
            url: base_url + "company/employeedetails/getRecordInfo",
