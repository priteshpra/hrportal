...
<body class="cyan login-page-cyan">
  ...
  <div id="login-page" class="row">
    <div class="">
      <form class="login-form z-depth-4 card-panel forgot-password-form" action="<?php echo $this->config->item('base_url'); ?>company/usersession/postResetPassword" method="post">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            <p class="margin sign-up right"><a href="<?php echo $this->config->item('base_url').'company-login'; ?>">Login</a></p>
          </div>
        </div>
      </form>
    </div>
...
<script>
    ...
    $('#forgot_button').click(function(){
		...
		if (email == ''){
			...
			$.ajax({
				url: "<?php echo base_url('company/usersession/checkIfEmailIDIsRegistered')?>",
				type:'POST',
				data: {email_id: email},
