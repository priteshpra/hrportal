    ...
    <div class="container">
        <div class="card-panel col s12">
            <h4 class="header m-t-0">
                <a href="<?php echo base_url() ?>company/employeedetails"><strong><?php echo label('msg_lbl_title_employeedetails')?></strong>
                </a>
            </h4>        
            <div class="row">
            <form class="col s12" id="addEmployeeForm" method="post" action="<?php echo $this->config->item('base_url'); ?>company/employeedetails/<?php echo $page_name; ?>">
                ...
                <div class="row">
                         ...
                         <div class="input-field col s12 m6">
                             <a class="tooltipped a-tooltipped" data-position="left" data-delay="50" data-tooltip="<?php echo label('msg_lbl_enter_email');?>"><i class="<?php echo INFO_ICON_CLASS; ?>"></i></a>
                            <input id="EmailID" name="EmailID" type="text" class="" value="<?php echo @$employeedetails->EmailID; ?>"  maxlength="" <?php if(isset($employeedetails->UserID)){echo "readonly";}?>/>
                ...
                <div class="row">
                        <div class="input-field col s12 m6">
                          <?php if(!isset($employeedetails->UserID)){ ?>
                            ...
                            <input id="iPassword" name="iPassword" type="password" class="empty_validation_class" value="<?php echo @$employeedetails->Password; ?>"  maxlength="100" <?php if(isset($employeedetails->UserID)){echo "readonly";}?>/>
                            <label for="iPassword"><?php echo label('msg_lbl_password')?></label>
                            <?php }?>
                         </div>
                         ...
                         <div class="input-field col s12 m6">
                          <?php if(!isset($employeedetails->UserID)){ ?>
                             <a class="tooltipped a-tooltipped" data-position="left" data-delay="50" data-tooltip="<?php echo label('msg_lbl_please_select_password');?>"><i class="<?php echo INFO_ICON_CLASS; ?>"></i></a>  
                            <input id="ConfirmPassword" name="ConfirmPassword" type="password" class="empty_validation_class" value=""  maxlength="100" <?php if(isset($employeedetails->UserID)){echo "readonly";}?>/>
                ...
                <div class="row">
                       <div class="input-field col s12 m6">
                             <!-- <a class="tooltipped a-tooltipped" data-position="left" data-delay="50" data-tooltip="<?php echo label('msg_lbl_select_designation');?>"><i class="<?php echo INFO_ICON_CLASS; ?>"></i></a>
                            <input id="DesignationID" name="DesignationID" type="text" value="<?php echo @$employeedetails->DesignationID; ?>"  maxlength="13"/>
                            <label for="DesignationID"><?php echo label('msg_lbl_designation')?></label> -->
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <a  href="<?php echo $this->config->item('base_url'); ?>company/employeedetails" class="right close-button">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
