...
<div id="card-stats">
    <div class="row">
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content  green white-text">
                    <p class="card-stats-title"><i class="mdi-social-group-add"></i> Job Posting</p>
                    <h4 class="card-stats-number"><?php echo ($dashboard['AllJob']) ? $dashboard['AllJob'] : 0; ?></h4>
                </div>
                <div class="card-action  green darken-2">
                    <div id="clients-bar"><canvas style="display: inline-block; width: 290px; height: 25px; vertical-align: top;" width="290" height="25"></canvas></div>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content purple white-text">
                    <p class="card-stats-title"><i class="mdi-social-group-add"></i>Short Listed</p>
                    <h4 class="card-stats-number"><?php echo ($dashboard['ShortListed']) ? $dashboard['ShortListed'] : 0; ?></h4>
                </div>
                <div class="card-action purple darken-2">
                    <div id="sales-compositebar"><canvas style="display: inline-block; width: 286px; height: 25px; vertical-align: top;" width="286" height="25"></canvas></div>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content blue-grey white-text">
                    <p class="card-stats-title"><i class="mdi-action-trending-up"></i> Applied</p>
                    <h4 class="card-stats-number"><?php echo ($dashboard['Applied']) ? $dashboard['Applied'] : 0; ?></h4>
                    </p>
                </div>
                <div class="card-action blue-grey darken-2">
                    <div id="profit-tristate"><canvas style="display: inline-block; width: 290px; height: 25px; vertical-align: top;" width="290" height="25"></canvas></div>
        ...
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content pink lighten-2 white-text">
                    <p class="card-stats-title"><i class="mdi-editor-cross"></i> Rejected</p>
                    <h4 class="card-stats-number"> <?php echo ($dashboard['Rejected']) ? $dashboard['Rejected'] : 0; ?></h4>
                    </p>
                </div>
                <div class="card-action  pink darken-2">
                    <div id="invoice-line"><canvas style="display: inline-block; width: 435px; height: 25px; vertical-align: top;" width="435" height="25"></canvas></div>
...
<div id="card-stats">
    <div class="row">
        <div class="col s12 m6 l3">
            <div class="card">
                <div class="card-content  green white-text">
                    <p class="card-stats-title"><i class="mdi-social-group-add"></i> Selected</p>
                    <h4 class="card-stats-number"><?php echo ($dashboard['Selected']) ? $dashboard['Selected'] : 0; ?></h4>
                </div>
                <div class="card-action  green darken-2">
                    <div id="clients-bar"><canvas style="display: inline-block; width: 290px; height: 25px; vertical-align: top;" width="290" height="25"></canvas></div>
                </div>
