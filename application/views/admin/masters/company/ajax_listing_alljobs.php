<?php //print_r($href);
    foreach ($alljobs as $alljobs) {  ?>
        ...
        <tr id="row_<?php echo $alljobs->JobPostID; ?>">
            <td>
                <a class="txt-underline bold" href="<?php echo site_url('admin/masters/jobpost/details/'.$alljobs->JobPostID);?>"><?php echo $alljobs->JobTitle; ?></a>
            </td>
            ...
            <td><a href="<?php echo "https://".$alljobs->WebsiteURL; ?>" target="_blank"><?php echo $alljobs->WebsiteURL; ?></a></td>
            <td><?=$alljobs->MobileNo; ?></td>          
            ...
            <td class="action center action-box-th">
                <a href="<?php echo site_url('admin/masters/jobpost/details/'.$alljobs->JobPostID.'#view_job');?>" data-target="modal1" class="info modal-trigger btn-floating waves-effect waves-light black" data-id="<?php echo @$alljobs->JobPostID; ?>">
                    <i title="<?php echo $viewlabel;?>" class="<?php echo VIEW_ICON_CLASS; ?>"></i>
                </a>
            </td>
            <td class="action center action-box-th">
                <a href="<?php echo site_url('admin/masters/jobpost/details/'.$alljobs->JobPostID.'#all_applied');?>" data-target="modal1" class="info modal-trigger btn-floating waves-effect waves-light black" data-id="<?php echo @$alljobs->JobPostID; ?>">
                    <i title="<?php echo $applylabel;?>" class="<?php echo APPLIED_ICON_CLASS; ?>"></i>
                </a>
            </td>
            <td class="action center action-box-th">
                <a href="<?php echo site_url('admin/masters/jobpost/details/'.$alljobs->JobPostID.'#all_invited');?>" data-target="modal1" class="info modal-trigger btn-floating waves-effect waves-light black" data-id="<?php echo @$alljobs->JobPostID; ?>">
                    <i title="<?php echo $invitedlabel;?>" class="<?php echo INTERVIEW_ICON_CLASS; ?>"></i>
                </a>
            </td>
            <td class="action center action-box-th">
                <a href="<?php echo site_url('admin/masters/jobpost/details/'.$alljobs->JobPostID.'#all_shortlisted');?>" data-target="modal1" class="info modal-trigger btn-floating waves-effect waves-light black" data-id="<?php echo @$alljobs->JobPostID; ?>">
