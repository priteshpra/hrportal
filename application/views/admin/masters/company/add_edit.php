                    ...
                    <div class="row">
                      ...
                      if(!isset($company->CompanyID)){ ?>
                       <div class="input-field col s12 m6">       
                            ...
                            <input id="EmailID" name="EmailID" type="email" class="empty_validation_class" value="<?php echo @$company->EmailID; ?>"  maxlength="255" <?php if(isset($company->CompanyID)){echo "readonly";}?>/>
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input id="Password" name="Password" type="password" class="" value="<?php echo @$company->Password; ?>"  maxlength="100" <?php if(isset($company->CompanyID)){echo "readonly";}?>/>
                      ...
                      <?php }?>
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input id="Latitude" name="Latitude" type="text" class="AmountOnly" value="<?php echo @$company->Latitude; ?>"  maxlength="20" />
                         ...
                         <div class="input-field col s12 m6">
                            ...
                            <input id="Longitude" name="Longitude" type="text" class="AmountOnly" value="<?php echo @$company->Longitude; ?>"  maxlength="20" />
