        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/occupation"> Occupation</a></h5>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="complaint-page-right">
                <div class="card-panel">
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <div class="col s2 right-align">
                                    ...
                                    <div class="right">
                                        <a href="<?php echo site_url("admin/masters/occupation/export_to_excel"); ?>" class="export-excel btn-floating  right waves-effect waves-light btn white-text"><i class="mdi-file-cloud-download"></i></a>
                                        <a href="<?php echo $this->config->item('base_url'); ?>admin/masters/occupation/add" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">                                
                                ...
                                <div class="row m-b-0">
                                    <div class="input-field col s6">
                                        ...
                                        <label name="Name" class="">Name</label>
                                    </div>                                     
                                ...
                                <button class="btn waves-effect waves-light right" type="button" id="button_occupation_submit" name="button_occupation_submit">Submit
                                </button>
                                &nbsp;&nbsp;&nbsp;

                                <a href="javascript:;" class="clear-all right" onclick="return clearAllFilter();">Clear All                                
                                </a> 
                    ...
                    <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                        ...
                        <tbody id="occupation_table_body">
