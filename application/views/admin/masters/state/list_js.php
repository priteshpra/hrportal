<script type="text/javascript">
 ...
 var field_name = ["StateName"]; 
   $("#state_table_body").on('click', '.status_change', function()
   {
    ...
    $("#state_table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_state";
