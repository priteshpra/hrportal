<script type="text/javascript">
   $(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_uom');?>");
 ...
 var field_name = ["Unit"]; 
   $("#data_table_body").on('click', '.status_change', function()
   {
    ...
    $("#data_table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_uom";
        var field_name = "UOMID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/uom/getRecordInfo",
