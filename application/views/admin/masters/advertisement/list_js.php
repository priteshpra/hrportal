<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/advertisement/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    Title: Title,
    ...
    $(document).ready(function () {
		...
		$("#model_title").html("<?php echo label('msg_lbl_advertisement');?>");
   ...
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/advertisement/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_advertisement";
        var field_name = "AdvertisementID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/advertisement/getRecordInfo",
