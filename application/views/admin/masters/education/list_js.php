<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/education/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
   ...
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/education/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_qualification";
        var field_name = "QualificationID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/education/getRecordInfo",
