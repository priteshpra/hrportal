                ...
                <form class="col s12" id="addStateForm" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/masters/candidate/<?php echo $page_name; ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input id="EmailID" name="EmailID" type="text" class="empty_validation_class" value="<?php echo @$candidate->EmailID; ?>" maxlength="150" <?php if (isset($candidate->CandidateID)) {
                    ...
                    <!-- <div class="row">
                        ...
                        <div class="input-field col s6">
                            <a class="tooltipped a-tooltipped" data-position="left" data-delay="50" data-tooltip="<?php //echo label('msg_lbl_please_select_pincode');
                                                                                                                    ?>"><i class="<?php echo INFO_ICON_CLASS; ?>"></i></a>
                            <input id="Pincode" name="Pincode" type="text" class=" NumberLetter InputCapital" value="<?php // echo @$candidate->Pincode; 
                                                                                                                        ?>"  maxlength="11" />
                            <label for="Pincode"><?php //echo label('msg_lbl_pincode')
                                                    ?></label>
                        </div>
                    </div> -->
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input name="Gender" type="radio" value="Female" id="Female" <?php
                                                                                            if ((isset($candidate->Gender) && $candidate->Gender == FEMALE) || !isset($candidate->Gender)) {
                            ...
                            <input name="Gender" type="radio" value="Male" id="Male" <?php
                                                                                        if (isset($candidate->Gender) && $candidate->Gender == MALE) {
                                                                                            echo "checked='checked'";
                                                                                        }
                                                                                        ?> />
                            <label for="Female"><?php echo MALE; ?></label>

                            <input name="Gender" type="radio" value="Other" id="Othergen" <?php
                                                                                            if (isset($candidate->Gender) && $candidate->Gender == OTHER) {
                                                                                                echo "checked='checked'";
                                                                                            }
                                                                                            ?> />
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <input name="IsWillingToRelocate" type="radio" value="1" id="yes" <?php
                                                                                                if ((isset($candidate->IsWillingToRelocate) && $candidate->IsWillingToRelocate == 1) || !isset($candidate->IsWillingToRelocate)) {
                                                                                                    echo "checked='checked'";
                                                                                                }
                                                                                                ?> />
                            ...
                            <input name="IsWillingToRelocate" type="radio" value="0" id="no" <?php
                                                                                                if (isset($candidate->IsWillingToRelocate) && $candidate->IsWillingToRelocate == 0) {
                                                                                                    echo "checked='checked'";
                                                                                                }
                                                                                                ?> />
                        ...
                        <div class="input-field col s6">
                            ...
                            <input name="HaveDrivingLicence" type="radio" value="1" id="yes" <?php
                                                                                                if ((isset($candidate->HaveDrivingLicence) && $candidate->HaveDrivingLicence == 1) || !isset($candidate->HaveDrivingLicence)) {
                                                                                                    echo "checked='checked'";
                                                                                                }
                                                                                                ?> />
                            <label for="yes"><?php echo "YES"; ?></label>
                            ...
                            <input name="HaveDrivingLicence" type="radio" value="0" id="no" <?php
                                                                                            if (isset($candidate->HaveDrivingLicence) && $candidate->HaveDrivingLicence == 0) {
                                                                                                echo "checked='checked'";
                                                                                            }
                                                                                            ?> />
                            <label for="no"><?php echo "NO"; ?></label>
