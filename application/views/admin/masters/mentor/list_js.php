<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/mentor/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    FirstName: FirstName,
					emailId: emailId,
    ...
    $(document).ready(function () {
		...
		$("#model_title").html("<?php echo label('msg_lbl_title_mentor');?>");
   ...
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/mentor/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_mentor";
        var field_name = "UserID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/mentor/getRecordInfo",
