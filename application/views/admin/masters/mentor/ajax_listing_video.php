...
foreach ($video as $video) { ?>
    <tr class="gradeX" id="row_<?php echo $video->VideoID; ?>">
		...
		<td align="center"><?php echo $video->VideoURL; ?></td>
        <td align="center"><?php 
                if($video->Flag == 1)
                    {echo "Free";}
        ...
        <?php if(@$this->cur_module->is_edit == 1){?>
            ...
            <a class="btn-floating waves-effect waves-light blue m-r-5" href="<?php echo $this->config->item('base_url'); ?>admin/masters/video/edit/<?php echo $video->VideoID; ?>" style="cursor:pointer;">
