    ...
    <div class="container">
        <div class="card-panel col s12">
            <h4 class="header m-t-0">
                <a href="<?php echo base_url() ?>admin/masters/jobpost"><strong><?php echo label('msg_lbl_title_jobpost') ?></strong>
                </a>
            </h4>
            <div class="row">
                <form class="col s12" id="addStateForm" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/masters/jobpost/<?php echo $page_name; ?>" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col s12 m6 m-t-10">
                            ...
                            $MinExperienceYear = $jobpost->MinExperience;
                            $MaxExperienceYear = $jobpost->MaxExperience;
                            ?>


                            <!-- <label for="MinExperience"><?php //echo label('msg_lbl_minexperience')
                                                            ?></label> -->
                        ...
                        <div class=" col s12 m6">
                            ...
                            <!-- <label for="MaxExperience"><?php //echo label('')
                                                            ?></label> -->
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <a href="<?php echo $this->config->item('base_url'); ?>admin/masters/jobpost" class="right close-button"><?php echo label('msg_lbl_cancel'); ?></a>
                        </div>
                    </div>
                </form>
            </div>
