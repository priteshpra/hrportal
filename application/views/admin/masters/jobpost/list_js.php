<script type="text/javascript">
    ...
    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/jobpost/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                Skills: Skills,
                Salary: Salary,
                SortBy: SortBy,
    ...
    $(document).ready(function() {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_jobpost'); ?>");
    ...
    $("#table_body").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/jobpost/changeStatus",
            data: {
                id: id,
                status: status
            },
    ...
    $("#table_body").on('click', '.info', function() { //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_jobpost";
        var field_name = "JobPostID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/jobpost/getRecordInfo",
            data: {
                id: id,
