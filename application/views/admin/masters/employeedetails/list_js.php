<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/employeedetails/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    FirstName:FirstName,
                    EmailID:EmailID,
                    MobileNo:MobileNo,
 ...
 var field_name = ["CountryName"]; 
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/employeedetails/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_admindetails";
        var field_name = "UserID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/employeedetails/getRecordInfo",
