<script type="text/javascript">
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            ...
            success: function (data)
            {
                ...
                $('#category_table_body').html(obj.a);
 ...
 var field_name = ["AreaName"]; 
   $("#category_table_body").on('click', '.status_change', function()
   {
    ...
    $("#category_table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "ssc_category";
