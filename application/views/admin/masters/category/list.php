                            ...
                            <div class="search_action card-panel" style="display:none;">                                
								...
								<div class="row m-b-0">
								  <div class="input-field col s12 m6">
									<input type="text" name="CategoryName" id="CategoryName" maxlength="50" class="form-control LetterOnly">
									<label name="CategoryName" class=""><?php echo label('msg_lbl_categoryname');?></label>
								  </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <thead>
                            <tr>
								...
								<th><?php echo label('msg_lbl_categoryname');?></th>
