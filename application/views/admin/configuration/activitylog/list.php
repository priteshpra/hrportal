                ...
                <div class="card-panel">
                        ...
                        <div class="col s12">
                            <div class="search_action card-panel" style="display:none;">                                
                                ...
                                <div class="row m-b-0">
                                    ...
                                    <div class="input-field col s12 m6">
                                        <input type="text" name="ActivityDate" id="ActivityDate" value="" class="datepicker1">
                    ...
                    <div class="table-responsive">
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th class="width_400"><?php echo label('msg_lbl_activitylogname');?></th>
                                    <th class="width_400"><?php echo label('msg_lbl_description');?></th>
