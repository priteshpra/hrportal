...
class Unregister_model extends CI_Model
{
    ...
    {
        // Insert data into the users table
        $this->db->insert('ssc_candidate', $data);
    ...
    public function update_user($id, $data)
    {
        ...
        $this->db->update('unregister_user', $data);

        // Optionally, return true/false based on success
    ...
    {
        $query = $this->db->query("call usp_A_GetUnregisterUserByID('$ID')");
        $query->next_result();
        return $query->row();
    }
